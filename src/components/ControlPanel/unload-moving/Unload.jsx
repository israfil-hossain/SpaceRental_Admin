...
import { spaceTypeHeadings, UnloadMovesHeadings } from "../../../constants/TableColumns/headings";
import DefaultTable from "../../common/DefaultTable";
import { deleteConfirmation } from "../../common/Toast/DeleteConfirmation";
import { toast } from "react-toastify";
import { UnloadAPI } from "../../../api/controlapi";
import AddUnloadMoving from "./AddUnloadMoving";

const SpaceUnloadMoving = () => {
  ...
  const SpaceTypeDeleteAPI = UnloadAPI.DeleteUnload;
  ...
  const {
    ...
    refetch,
  } = useQuery([UnloadAPI.GetUnloadAll]);
...
export default SpaceUnloadMoving;
