...
const AddStorageCondition = ({ refetch, open, onClose }) => {
  const [status, setStatus] = useState(true);

  const { mutateAsync: createmutate, isLoading: createLoading } = useCreate({
    endpoint: StorageAPI.StorageCreate, // Replace with your actual API endpoint
    onSuccess: (data) => {
      toast.success("Add Storage Successfully !");
      refetch();
      onClose();
    },
    onError: (error) => {
          ...
          <Box sx={style}>
            <div>
              <Formik
                ...
                validationSchema={storageValidation}
...
export default AddStorageCondition;
