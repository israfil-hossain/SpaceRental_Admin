...
const AddScheduleSpace = ({ data, refetch, open, onClose }) => {
  const [status, setStatus] = useState(true);

  const { mutateAsync: createmutate, isLoading: createLoading } = useCreate({
    endpoint: SpaceScheduleAPI.SpaceScheduleCreate, // Replace with your actual API endpoint
    onSuccess: (data) => {
      toast.success("Add Space Schedule Successfully !");
      refetch();
      onClose();
    },
    onError: (error) => {
                  ...
                  <Form>
                    ...
                    >
                      <Typography variant="h5" component="h5">
                        {data ? "Update " : "Add "} Space Schedule
                      </Typography>
                      <div style={{}}>
                        <IconButton
                          aria-label="edit"
...
export default AddScheduleSpace;
