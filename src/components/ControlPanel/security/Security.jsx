...
import { SecurityHeadings, spaceTypeHeadings } from "../../../constants/TableColumns/headings";
import DefaultTable from "../../common/DefaultTable";
import { deleteConfirmation } from "../../common/Toast/DeleteConfirmation";
import { toast } from "react-toastify";
import { SpaceSecurityAPI } from "../../../api/controlapi";
...
const SpaceSecurity = () => {
  ...
  const SecurityDeleteAPI = SpaceSecurityAPI.DeleteSpaceSecurity;
  ...
  const {
    ...
    refetch,
  } = useQuery([SpaceSecurityAPI.GetSpaceSecurity]);

  // Delte Mutation ....
  const deleteMutation = useDelete({
    endpoint: SecurityDeleteAPI,
  });
