...
const AddSecurity = ({refetch, open, onClose }) => {
  const [status, setStatus] = useState(true);

  const { mutateAsync: createmutate, isLoading: createLoading } = useCreate({
    endpoint: SpaceSecurityAPI.SpaceSecurityCreate, // Replace with your actual API endpoint
    onSuccess: (data) => {
      toast.success("Add Security Successfully !");
      refetch();
      onClose();
    },
    onError: (error) => {
