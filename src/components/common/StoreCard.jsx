...
const StoreCard = ({ data }) => {
  return (
    <div className="max-w-[400px] h-[320px] relative ">
      <div className="w-[400px] h-[320px]  left-0 top-0 absolute items-center justify-center flex bg-white rounded-3xl shadow border border-yellow-400">
        <img
        src={data?.coverImage || "https://via.placeholder.com/364x194"}
          className="w-full overflow-hidden h-52 px-3 pt-2 top-[5px] absolute rounded-3xl"
      ...
      <div className="max-w-[360px] h-[27px] left-[16px] top-[287px] absolute flex justify-between">
        <div className="left-0 top-[3px] absolute text-zinc-800 text-sm font-medium font-sanse leading-[21px]">
          {data?.accessMethod}
        </div>
        <div className="w-[76px] h-[27px] left-[250px] top-0 absolute justify-start items-center gap-1 inline-flex">
      ...
      <div className="w-[105px] h-[34px] px-4 py-2 left-[24px] top-[24px] absolute bg-cyan-200 rounded-lg justify-center items-center gap-2 inline-flex">
        <img className="w-[18px] h-[18px] rounded-full" src={data?.ownerProfilePicture || profile} />
